...
def generate_launch_description():
    ...
    jetty_demo_dir = Path(get_package_share_directory('jetty_demo'))
    ...
    robot_name = 'tb4'
    # robot_sdf = xacro.process(jetty_demo_dir / 'models' / 'jetty_tb4.urdf.xacro')
    desc_path = Path(get_package_share_directory('nav2_minimal_tb4_description'))
    robot_sdf = xacro.process(desc_path / 'urdf' / 'standard' / 'turtlebot4.urdf.xacro')
    ...
    camera_bridge = RosGzBridge(
        ...
        config_file=str(jetty_demo_dir / 'configs' / 'tb4_camera_bridge.yaml'),
        use_composition='False',
        namespace=namespace,
    )
